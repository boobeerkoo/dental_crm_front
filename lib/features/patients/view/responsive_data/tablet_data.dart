...
class TabletDataScreen extends StatefulWidget {
  ...
  const TabletDataScreen({super.key, required this.patient});
...
class _TabletDataScreenState extends State<TabletDataScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocProvider<PatientsBloc>(
        create: (context) {
          return patientsBloc;
        },
        child: Column(
                    ...
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          //   color: AppColors.mainBlueColor,
                          //   prefixImage:
                          //       const AssetImage('assets/images/tooth.png'),
                          //   text: 'Зубна формула',
                          //   onTap: () {},
                          // ),
                          const SizedBox(height: 10),
  ...
  MultiBlocListener _dataForm(BuildContext context) {
            ...
            Stack(
              ...
              children: [
                TextFormField(
                  ...
                  decoration: const InputDecoration(labelText: 'Телефон 1'),
                  enabled: isEditing,
                ),
              ],
            ),
