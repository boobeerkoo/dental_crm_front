...
final CustomAppointmentDataSource dataSource =
    CustomAppointmentDataSource(getAppointments());
...
class _DesktopScheduleState extends State<DesktopSchedule> {
  ...
  void handleAppointmentsLoaded(Appointments appointments) {
    dataSource.appointments.clear(); // Clear existing appointments
                      ...
                      listener: (context, state) {
                        if (state is AppointmentErrorState) {
                          ...
                          MotionToast.error(
                              ...
                              .show(context);
                          print(error);
                          dataSource.appointments.removeLast();
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 10),
                      Text(
                          '${duration.inHours} год. ${duration.inMinutes - duration.inHours * 60} хв.'),
                    ],
                  ),
                  TextField(
